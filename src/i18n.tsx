...
const zhCN: Dictionary = {
  ...
  'product.course.notice': '将于 9 月 12 日下线',
...
const zhTW: Dictionary = {
  ...
  'product.course.notice': '將於 9 月 12 日下線',
  'product.hub.title': 'YourTJHub',
...
const en: Dictionary = {
  ...
  'product.course.notice': 'Closing on Sep 12',
  'product.hub.title': 'YourTJHub',
...
const ja: Dictionary = {
  ...
  'product.course.notice': '9月12日に終了予定',
  'product.hub.title': 'YourTJHub',
...
const de: Dictionary = {
  ...
  'product.course.notice': 'Wird am 12. Sept. eingestellt',
  'product.hub.title': 'YourTJHub',
