...
export const BackgroundWaves: React.FC = () => {
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden bg-wabi-paper dark:bg-wabi-dark-paper transition-colors duration-500">
      ...
      <div className="absolute inset-0 z-[1] bg-none md:bg-paper-pattern opacity-60 dark:opacity-40 md:mix-blend-multiply dark:md:mix-blend-overlay pointer-events-none transition-opacity duration-500"></div>
